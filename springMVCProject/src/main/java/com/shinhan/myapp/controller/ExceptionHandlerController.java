...
//global exception 처리: @ControllerAdvice
@ControllerAdvice
public class ExceptionHandlerController {
	...
	//요청 주소가 잘못됐을때, 문제점: static 자원과 충돌
	//*.do 요청 => DispatcherServlet이 받아서 handler가 없는 주소이면 오류를 일으킨다.
	//static 자원과 충돌되지 않고 잘 수행한다.
	// /* => 문제: static자원과 충돌
