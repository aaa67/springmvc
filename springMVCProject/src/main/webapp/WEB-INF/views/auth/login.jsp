...
<div class="container mt-3">
  ...
  <form action="${path}/auth/login.do" method="post">
    <div class="mb-3 mt-3">
      ...
      <input type="text" class="form-control" id="email" value="SKING" name="email">
    </div>
    <div class="mb-3">
      <label for="pwd">Password:</label>
      <input type="password" class="form-control" id="pwd" value="515.123.4567" name="pswd">
    </div>
    <div class="form-check mb-3">
      <label class="form-check-label">
        <input class="form-check-input" type="checkbox" id="remember" value="1"> Remember me
      </label>
    </div>
