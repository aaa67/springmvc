...
function f_detail(){
	$.ajax({
		...
		success:function(responseData){
			var output = "";
			output += "<p> 부서 아이디: " + responseData.department_id + "</p>";
			output += "<p> 부서 이름: " + responseData.department_name + "</p>";
			output += "<p> 매니저 아이디: " + responseData.manager_id + "</p>";
			output += "<p> 지역 코드: " + responseData.location_id + "</p>";
